...
@Slf4j
@CommandLine.Command(name = "performance_tester", mixinStandardHelpOptions = true, version = "1.0.0", subcommands = {NettyProbe.class, FixYouClient.class, QuickfixClient.class, FixioClient.class, Sumup.class})
