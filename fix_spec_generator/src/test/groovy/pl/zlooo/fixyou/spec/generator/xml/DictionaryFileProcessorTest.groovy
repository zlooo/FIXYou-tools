...
import pl.zlooo.fixyou.spec.generator.xml.model.XMLModelTest
...
class DictionaryFileProcessorTest extends Specification {
    ...
    def "should process default fix 50sp2 dictionary"() {
        setup:
        JAXBElement<FixType> fix50sp2 = JAXBContext.newInstance("pl.zlooo.fixyou.spec.generator.xml.model").createUnmarshaller().unmarshal(XMLModelTest.STANDARD_DICTIONARIES.find { file -> file.getName() == "FIX50SP2.xml" })
