package pl.zlooo.fixyou.spec.generator.xml;
...
import pl.zlooo.fixyou.spec.generator.xml.model.ComponentType;
import pl.zlooo.fixyou.spec.generator.xml.model.FixType;
import pl.zlooo.fixyou.spec.generator.xml.model.GroupType;
import pl.zlooo.fixyou.spec.generator.xml.model.MessageType;
...
public class DictionaryFileProcessor {
    ...
    public Result process(FixType objectToProcess) {
        ...
        final List<pl.zlooo.fixyou.spec.generator.xml.model.FieldType> fields = objectToProcess.getFields().getField();
        ...
        final Map<String, pl.zlooo.fixyou.spec.generator.xml.model.FieldType> nameToField = new HashMap<>(fields.size());
        ...
        for (final pl.zlooo.fixyou.spec.generator.xml.model.FieldType field : fields) {
    ...
    private void setFieldNumberToTypesMapEntries(List<pl.zlooo.fixyou.spec.generator.xml.model.FieldType> fields, Map<Integer, FieldType> fieldNumbersToTypes, Map<String, pl.zlooo.fixyou.spec.generator.xml.model.FieldType> nameToField) {
        final pl.zlooo.fixyou.spec.generator.xml.model.FieldType beginString = nameToField.get("BeginString");
        fieldNumbersToTypes.put(beginString.getNumber(), FIELD_TYPES.get(beginString.getType()));
        final pl.zlooo.fixyou.spec.generator.xml.model.FieldType bodyLength = nameToField.get("BodyLength");
        fieldNumbersToTypes.put(bodyLength.getNumber(), FIELD_TYPES.get(bodyLength.getType()));
        final pl.zlooo.fixyou.spec.generator.xml.model.FieldType msgType = nameToField.get("MsgType");
    ...
    private BiFunction<? super GroupType, ? super GroupType, ? extends GroupType> groupMergingFunction() {
        return (group1, group2) -> {
            ...
            addItemsThatAreNotPresent(group1.getField(), group2.getField(), pl.zlooo.fixyou.spec.generator.xml.model.FieldType::getName);
            return group1;
        };
    }
    ...
    private static FixSpec.FieldNumberTypePair[] buildFieldNumberTypePairs(GroupType groupToProcess, Map<String, pl.zlooo.fixyou.spec.generator.xml.model.FieldType> nameToField,
